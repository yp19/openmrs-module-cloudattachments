 ...
 */
package org.openmrs.module.cloudattachments.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.CloudAttachmentsController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class CloudAttachmentsController {
